...
char *ops[4096] = {
	...
	"TAD I @@140 ;Add operand to AC, Indexed Current page @@140",							 // op 1740
	"TAD I @@141 ;Add operand to AC, Indexed Current page @@141",							 // op 1741
	"TAD I @@142 ;Add operand to AC, Indexed Current page @@142",							 // op 1742
	"TAD I @@143 ;Add operand to AC, Indexed Current page @@143",							 // op 1743
	"TAD I @@144 ;Add operand to AC, Indexed Current page @@144",							 // op 1744
	"TAD I @@145 ;Add operand to AC, Indexed Current page @@145",							 // op 1745
	"TAD I @@146 ;Add operand to AC, Indexed Current page @@146",							 // op 1746
	"TAD I @@147 ;Add operand to AC, Indexed Current page @@147",							 // op 1747
	"TAD I @@150 ;Add operand to AC, Indexed Current page @@150",							 // op 1750
	"TAD I @@151 ;Add operand to AC, Indexed Current page @@151",							 // op 1751
	"TAD I @@152 ;Add operand to AC, Indexed Current page @@152",							 // op 1752
	"TAD I @@153 ;Add operand to AC, Indexed Current page @@153",							 // op 1753
	"TAD I @@154 ;Add operand to AC, Indexed Current page @@154",							 // op 1754
	"TAD I @@155 ;Add operand to AC, Indexed Current page @@155",							 // op 1755
	"TAD I @@156 ;Add operand to AC, Indexed Current page @@156",							 // op 1756
	"TAD I @@157 ;Add operand to AC, Indexed Current page @@157",							 // op 1757
	"TAD I @@160 ;Add operand to AC, Indexed Current page @@160",							 // op 1760
	"TAD I @@161 ;Add operand to AC, Indexed Current page @@161",							 // op 1761
	"TAD I @@162 ;Add operand to AC, Indexed Current page @@162",							 // op 1762
	"TAD I @@163 ;Add operand to AC, Indexed Current page @@163",							 // op 1763
	"TAD I @@164 ;Add operand to AC, Indexed Current page @@164",							 // op 1764
	"TAD I @@165 ;Add operand to AC, Indexed Current page @@165",							 // op 1765
	"TAD I @@166 ;Add operand to AC, Indexed Current page @@166",							 // op 1766
	"TAD I @@167 ;Add operand to AC, Indexed Current page @@167",							 // op 1767
	"TAD I @@170 ;Add operand to AC, Indexed Current page @@170",							 // op 1770
	"TAD I @@171 ;Add operand to AC, Indexed Current page @@171",							 // op 1771
	"TAD I @@172 ;Add operand to AC, Indexed Current page @@172",							 // op 1772
	"TAD I @@173 ;Add operand to AC, Indexed Current page @@173",							 // op 1773
	"TAD I @@174 ;Add operand to AC, Indexed Current page @@174",							 // op 1774
	"TAD I @@175 ;Add operand to AC, Indexed Current page @@175",							 // op 1775
	"TAD I @@176 ;Add operand to AC, Indexed Current page @@176",							 // op 1776
	"TAD I @@177 ;Add operand to AC, Indexed Current page @@177",							 // op 1777
	...
	"ISZ @@100  ;Increment operand and skip if zero, Current page @@100",					 // op 2300
	"ISZ @@101  ;Increment operand and skip if zero, Current page @@101",					 // op 2301
	"ISZ @@102  ;Increment operand and skip if zero, Current page @@102",					 // op 2302
	"ISZ @@103  ;Increment operand and skip if zero, Current page @@103",					 // op 2303
	"ISZ @@104  ;Increment operand and skip if zero, Current page @@104",					 // op 2304
	"ISZ @@105  ;Increment operand and skip if zero, Current page @@105",					 // op 2305
	"ISZ @@106  ;Increment operand and skip if zero, Current page @@106",					 // op 2306
	"ISZ @@107  ;Increment operand and skip if zero, Current page @@107",					 // op 2307
	"ISZ @@110  ;Increment operand and skip if zero, Current page @@110",					 // op 2310
	"ISZ @@111  ;Increment operand and skip if zero, Current page @@111",					 // op 2311
	"ISZ @@112  ;Increment operand and skip if zero, Current page @@112",					 // op 2312
	"ISZ @@113  ;Increment operand and skip if zero, Current page @@113",					 // op 2313
	"ISZ @@114  ;Increment operand and skip if zero, Current page @@114",					 // op 2314
	"ISZ @@115  ;Increment operand and skip if zero, Current page @@115",					 // op 2315
	"ISZ @@116  ;Increment operand and skip if zero, Current page @@116",					 // op 2316
	"ISZ @@117  ;Increment operand and skip if zero, Current page @@117",					 // op 2317
	"ISZ @@120  ;Increment operand and skip if zero, Current page @@120",					 // op 2320
	"ISZ @@121  ;Increment operand and skip if zero, Current page @@121",					 // op 2321
	"ISZ @@122  ;Increment operand and skip if zero, Current page @@122",					 // op 2322
	"ISZ @@123  ;Increment operand and skip if zero, Current page @@123",					 // op 2323
	"ISZ @@124  ;Increment operand and skip if zero, Current page @@124",					 // op 2324
	"ISZ @@125  ;Increment operand and skip if zero, Current page @@125",					 // op 2325
	"ISZ @@126  ;Increment operand and skip if zero, Current page @@126",					 // op 2326
	"ISZ @@127  ;Increment operand and skip if zero, Current page @@127",					 // op 2327
	"ISZ @@130  ;Increment operand and skip if zero, Current page @@130",					 // op 2330
	"ISZ @@131  ;Increment operand and skip if zero, Current page @@131",					 // op 2331
	"ISZ @@132  ;Increment operand and skip if zero, Current page @@132",					 // op 2332
	"ISZ @@133  ;Increment operand and skip if zero, Current page @@133",					 // op 2333
	"ISZ @@134  ;Increment operand and skip if zero, Current page @@134",					 // op 2334
	"ISZ @@135  ;Increment operand and skip if zero, Current page @@135",					 // op 2335
	"ISZ @@136  ;Increment operand and skip if zero, Current page @@136",					 // op 2336
	"ISZ @@137  ;Increment operand and skip if zero, Current page @@137",					 // op 2337
	"ISZ @@140  ;Increment operand and skip if zero, Current page @@140",					 // op 2340
	"ISZ @@141  ;Increment operand and skip if zero, Current page @@141",					 // op 2341
	"ISZ @@142  ;Increment operand and skip if zero, Current page @@142",					 // op 2342
	"ISZ @@143  ;Increment operand and skip if zero, Current page @@143",					 // op 2343
	"ISZ @@144  ;Increment operand and skip if zero, Current page @@144",					 // op 2344
	"ISZ @@145  ;Increment operand and skip if zero, Current page @@145",					 // op 2345
	"ISZ @@146  ;Increment operand and skip if zero, Current page @@146",					 // op 2346
	"ISZ @@147  ;Increment operand and skip if zero, Current page @@147",					 // op 2347
	"ISZ @@150  ;Increment operand and skip if zero, Current page @@150",					 // op 2350
	"ISZ @@151  ;Increment operand and skip if zero, Current page @@151",					 // op 2351
	"ISZ @@152  ;Increment operand and skip if zero, Current page @@152",					 // op 2352
	"ISZ @@153  ;Increment operand and skip if zero, Current page @@153",					 // op 2353
	"ISZ @@154  ;Increment operand and skip if zero, Current page @@154",					 // op 2354
	"ISZ @@155  ;Increment operand and skip if zero, Current page @@155",					 // op 2355
	"ISZ @@156  ;Increment operand and skip if zero, Current page @@156",					 // op 2356
	"ISZ @@157  ;Increment operand and skip if zero, Current page @@157",					 // op 2357
	"ISZ @@160  ;Increment operand and skip if zero, Current page @@160",					 // op 2360
	"ISZ @@161  ;Increment operand and skip if zero, Current page @@161",					 // op 2361
	"ISZ @@162  ;Increment operand and skip if zero, Current page @@162",					 // op 2362
	"ISZ @@163  ;Increment operand and skip if zero, Current page @@163",					 // op 2363
	"ISZ @@164  ;Increment operand and skip if zero, Current page @@164",					 // op 2364
	"ISZ @@165  ;Increment operand and skip if zero, Current page @@165",					 // op 2365
	"ISZ @@166  ;Increment operand and skip if zero, Current page @@166",					 // op 2366
	"ISZ @@167  ;Increment operand and skip if zero, Current page @@167",					 // op 2367
	"ISZ @@170  ;Increment operand and skip if zero, Current page @@170",					 // op 2370
	"ISZ @@171  ;Increment operand and skip if zero, Current page @@171",					 // op 2371
	"ISZ @@172  ;Increment operand and skip if zero, Current page @@172",					 // op 2372
	"ISZ @@173  ;Increment operand and skip if zero, Current page @@173",					 // op 2373
	"ISZ @@174  ;Increment operand and skip if zero, Current page @@174",					 // op 2374
	"ISZ @@175  ;Increment operand and skip if zero, Current page @@175",					 // op 2375
	"ISZ @@176  ;Increment operand and skip if zero, Current page @@176",					 // op 2376
	"ISZ @@177  ;Increment operand and skip if zero, Current page @@177",					 // op 2377
	...
	"ISZ I @@100 ;Increment operand and skip if zero, Indexed Current page @@100",			 // op 2700
	"ISZ I @@101 ;Increment operand and skip if zero, Indexed Current page @@101",			 // op 2701
	"ISZ I @@102 ;Increment operand and skip if zero, Indexed Current page @@102",			 // op 2702
	"ISZ I @@103 ;Increment operand and skip if zero, Indexed Current page @@103",			 // op 2703
	"ISZ I @@104 ;Increment operand and skip if zero, Indexed Current page @@104",			 // op 2704
	"ISZ I @@105 ;Increment operand and skip if zero, Indexed Current page @@105",			 // op 2705
	"ISZ I @@106 ;Increment operand and skip if zero, Indexed Current page @@106",			 // op 2706
	"ISZ I @@107 ;Increment operand and skip if zero, Indexed Current page @@107",			 // op 2707
	"ISZ I @@110 ;Increment operand and skip if zero, Indexed Current page @@110",			 // op 2710
	"ISZ I @@111 ;Increment operand and skip if zero, Indexed Current page @@111",			 // op 2711
	"ISZ I @@112 ;Increment operand and skip if zero, Indexed Current page @@112",			 // op 2712
	"ISZ I @@113 ;Increment operand and skip if zero, Indexed Current page @@113",			 // op 2713
	"ISZ I @@114 ;Increment operand and skip if zero, Indexed Current page @@114",			 // op 2714
	"ISZ I @@115 ;Increment operand and skip if zero, Indexed Current page @@115",			 // op 2715
	"ISZ I @@116 ;Increment operand and skip if zero, Indexed Current page @@116",			 // op 2716
	"ISZ I @@117 ;Increment operand and skip if zero, Indexed Current page @@117",			 // op 2717
	"ISZ I @@120 ;Increment operand and skip if zero, Indexed Current page @@120",			 // op 2720
	"ISZ I @@121 ;Increment operand and skip if zero, Indexed Current page @@121",			 // op 2721
	"ISZ I @@122 ;Increment operand and skip if zero, Indexed Current page @@122",			 // op 2722
	"ISZ I @@123 ;Increment operand and skip if zero, Indexed Current page @@123",			 // op 2723
	"ISZ I @@124 ;Increment operand and skip if zero, Indexed Current page @@124",			 // op 2724
	"ISZ I @@125 ;Increment operand and skip if zero, Indexed Current page @@125",			 // op 2725
	"ISZ I @@126 ;Increment operand and skip if zero, Indexed Current page @@126",			 // op 2726
	"ISZ I @@127 ;Increment operand and skip if zero, Indexed Current page @@127",			 // op 2727
	"ISZ I @@130 ;Increment operand and skip if zero, Indexed Current page @@130",			 // op 2730
	"ISZ I @@131 ;Increment operand and skip if zero, Indexed Current page @@131",			 // op 2731
	"ISZ I @@132 ;Increment operand and skip if zero, Indexed Current page @@132",			 // op 2732
	"ISZ I @@133 ;Increment operand and skip if zero, Indexed Current page @@133",			 // op 2733
	"ISZ I @@134 ;Increment operand and skip if zero, Indexed Current page @@134",			 // op 2734
	"ISZ I @@135 ;Increment operand and skip if zero, Indexed Current page @@135",			 // op 2735
	"ISZ I @@136 ;Increment operand and skip if zero, Indexed Current page @@136",			 // op 2736
	"ISZ I @@137 ;Increment operand and skip if zero, Indexed Current page @@137",			 // op 2737
	"ISZ I @@140 ;Increment operand and skip if zero, Indexed Current page @@140",			 // op 2740
	"ISZ I @@141 ;Increment operand and skip if zero, Indexed Current page @@141",			 // op 2741
	"ISZ I @@142 ;Increment operand and skip if zero, Indexed Current page @@142",			 // op 2742
	"ISZ I @@143 ;Increment operand and skip if zero, Indexed Current page @@143",			 // op 2743
	"ISZ I @@144 ;Increment operand and skip if zero, Indexed Current page @@144",			 // op 2744
	"ISZ I @@145 ;Increment operand and skip if zero, Indexed Current page @@145",			 // op 2745
	"ISZ I @@146 ;Increment operand and skip if zero, Indexed Current page @@146",			 // op 2746
	"ISZ I @@147 ;Increment operand and skip if zero, Indexed Current page @@147",			 // op 2747
	"ISZ I @@150 ;Increment operand and skip if zero, Indexed Current page @@150",			 // op 2750
	"ISZ I @@151 ;Increment operand and skip if zero, Indexed Current page @@151",			 // op 2751
	"ISZ I @@152 ;Increment operand and skip if zero, Indexed Current page @@152",			 // op 2752
	"ISZ I @@153 ;Increment operand and skip if zero, Indexed Current page @@153",			 // op 2753
	"ISZ I @@154 ;Increment operand and skip if zero, Indexed Current page @@154",			 // op 2754
	"ISZ I @@155 ;Increment operand and skip if zero, Indexed Current page @@155",			 // op 2755
	"ISZ I @@156 ;Increment operand and skip if zero, Indexed Current page @@156",			 // op 2756
	"ISZ I @@157 ;Increment operand and skip if zero, Indexed Current page @@157",			 // op 2757
	"ISZ I @@160 ;Increment operand and skip if zero, Indexed Current page @@160",			 // op 2760
	"ISZ I @@161 ;Increment operand and skip if zero, Indexed Current page @@161",			 // op 2761
	"ISZ I @@162 ;Increment operand and skip if zero, Indexed Current page @@162",			 // op 2762
	"ISZ I @@163 ;Increment operand and skip if zero, Indexed Current page @@163",			 // op 2763
	"ISZ I @@164 ;Increment operand and skip if zero, Indexed Current page @@164",			 // op 2764
	"ISZ I @@165 ;Increment operand and skip if zero, Indexed Current page @@165",			 // op 2765
	"ISZ I @@166 ;Increment operand and skip if zero, Indexed Current page @@166",			 // op 2766
	"ISZ I @@167 ;Increment operand and skip if zero, Indexed Current page @@167",			 // op 2767
	"ISZ I @@170 ;Increment operand and skip if zero, Indexed Current page @@170",			 // op 2770
	"ISZ I @@171 ;Increment operand and skip if zero, Indexed Current page @@171",			 // op 2771
	"ISZ I @@172 ;Increment operand and skip if zero, Indexed Current page @@172",			 // op 2772
	"ISZ I @@173 ;Increment operand and skip if zero, Indexed Current page @@173",			 // op 2773
	"ISZ I @@174 ;Increment operand and skip if zero, Indexed Current page @@174",			 // op 2774
	"ISZ I @@175 ;Increment operand and skip if zero, Indexed Current page @@175",			 // op 2775
	"ISZ I @@176 ;Increment operand and skip if zero, Indexed Current page @@176",			 // op 2776
	"ISZ I @@177 ;Increment operand and skip if zero, Indexed Current page @@177",			 // op 2777
	...
	"DCA @@100  ;Deposit AC to memory then clear AC, Current page @@100",					 // op 3300
	"DCA @@101  ;Deposit AC to memory then clear AC, Current page @@101",					 // op 3301
	"DCA @@102  ;Deposit AC to memory then clear AC, Current page @@102",					 // op 3302
	"DCA @@103  ;Deposit AC to memory then clear AC, Current page @@103",					 // op 3303
	"DCA @@104  ;Deposit AC to memory then clear AC, Current page @@104",					 // op 3304
	"DCA @@105  ;Deposit AC to memory then clear AC, Current page @@105",					 // op 3305
	"DCA @@106  ;Deposit AC to memory then clear AC, Current page @@106",					 // op 3306
	"DCA @@107  ;Deposit AC to memory then clear AC, Current page @@107",					 // op 3307
	"DCA @@110  ;Deposit AC to memory then clear AC, Current page @@110",					 // op 3310
	"DCA @@111  ;Deposit AC to memory then clear AC, Current page @@111",					 // op 3311
	"DCA @@112  ;Deposit AC to memory then clear AC, Current page @@112",					 // op 3312
	"DCA @@113  ;Deposit AC to memory then clear AC, Current page @@113",					 // op 3313
	"DCA @@114  ;Deposit AC to memory then clear AC, Current page @@114",					 // op 3314
	"DCA @@115  ;Deposit AC to memory then clear AC, Current page @@115",					 // op 3315
	"DCA @@116  ;Deposit AC to memory then clear AC, Current page @@116",					 // op 3316
	"DCA @@117  ;Deposit AC to memory then clear AC, Current page @@117",					 // op 3317
	"DCA @@120  ;Deposit AC to memory then clear AC, Current page @@120",					 // op 3320
	"DCA @@121  ;Deposit AC to memory then clear AC, Current page @@121",					 // op 3321
	"DCA @@122  ;Deposit AC to memory then clear AC, Current page @@122",					 // op 3322
	"DCA @@123  ;Deposit AC to memory then clear AC, Current page @@123",					 // op 3323
	"DCA @@124  ;Deposit AC to memory then clear AC, Current page @@124",					 // op 3324
	"DCA @@125  ;Deposit AC to memory then clear AC, Current page @@125",					 // op 3325
	"DCA @@126  ;Deposit AC to memory then clear AC, Current page @@126",					 // op 3326
	"DCA @@127  ;Deposit AC to memory then clear AC, Current page @@127",					 // op 3327
	"DCA @@130  ;Deposit AC to memory then clear AC, Current page @@130",					 // op 3330
	"DCA @@131  ;Deposit AC to memory then clear AC, Current page @@131",					 // op 3331
	"DCA @@132  ;Deposit AC to memory then clear AC, Current page @@132",					 // op 3332
	"DCA @@133  ;Deposit AC to memory then clear AC, Current page @@133",					 // op 3333
	"DCA @@134  ;Deposit AC to memory then clear AC, Current page @@134",					 // op 3334
	"DCA @@135  ;Deposit AC to memory then clear AC, Current page @@135",					 // op 3335
	"DCA @@136  ;Deposit AC to memory then clear AC, Current page @@136",					 // op 3336
	"DCA @@137  ;Deposit AC to memory then clear AC, Current page @@137",					 // op 3337
	"DCA @@140  ;Deposit AC to memory then clear AC, Current page @@140",					 // op 3340
	"DCA @@141  ;Deposit AC to memory then clear AC, Current page @@141",					 // op 3341
	"DCA @@142  ;Deposit AC to memory then clear AC, Current page @@142",					 // op 3342
	"DCA @@143  ;Deposit AC to memory then clear AC, Current page @@143",					 // op 3343
	"DCA @@144  ;Deposit AC to memory then clear AC, Current page @@144",					 // op 3344
	"DCA @@145  ;Deposit AC to memory then clear AC, Current page @@145",					 // op 3345
	"DCA @@146  ;Deposit AC to memory then clear AC, Current page @@146",					 // op 3346
	"DCA @@147  ;Deposit AC to memory then clear AC, Current page @@147",					 // op 3347
	"DCA @@150  ;Deposit AC to memory then clear AC, Current page @@150",					 // op 3350
	"DCA @@151  ;Deposit AC to memory then clear AC, Current page @@151",					 // op 3351
	"DCA @@152  ;Deposit AC to memory then clear AC, Current page @@152",					 // op 3352
	"DCA @@153  ;Deposit AC to memory then clear AC, Current page @@153",					 // op 3353
	"DCA @@154  ;Deposit AC to memory then clear AC, Current page @@154",					 // op 3354
	"DCA @@155  ;Deposit AC to memory then clear AC, Current page @@155",					 // op 3355
	"DCA @@156  ;Deposit AC to memory then clear AC, Current page @@156",					 // op 3356
	"DCA @@157  ;Deposit AC to memory then clear AC, Current page @@157",					 // op 3357
	"DCA @@160  ;Deposit AC to memory then clear AC, Current page @@160",					 // op 3360
	"DCA @@161  ;Deposit AC to memory then clear AC, Current page @@161",					 // op 3361
	"DCA @@162  ;Deposit AC to memory then clear AC, Current page @@162",					 // op 3362
	"DCA @@163  ;Deposit AC to memory then clear AC, Current page @@163",					 // op 3363
	"DCA @@164  ;Deposit AC to memory then clear AC, Current page @@164",					 // op 3364
	"DCA @@165  ;Deposit AC to memory then clear AC, Current page @@165",					 // op 3365
	"DCA @@166  ;Deposit AC to memory then clear AC, Current page @@166",					 // op 3366
	"DCA @@167  ;Deposit AC to memory then clear AC, Current page @@167",					 // op 3367
	"DCA @@170  ;Deposit AC to memory then clear AC, Current page @@170",					 // op 3370
	"DCA @@171  ;Deposit AC to memory then clear AC, Current page @@171",					 // op 3371
	"DCA @@172  ;Deposit AC to memory then clear AC, Current page @@172",					 // op 3372
	"DCA @@173  ;Deposit AC to memory then clear AC, Current page @@173",					 // op 3373
	"DCA @@174  ;Deposit AC to memory then clear AC, Current page @@174",					 // op 3374
	"DCA @@175  ;Deposit AC to memory then clear AC, Current page @@175",					 // op 3375
	"DCA @@176  ;Deposit AC to memory then clear AC, Current page @@176",					 // op 3376
	"DCA @@177  ;Deposit AC to memory then clear AC, Current page @@177",					 // op 3377
	...
	"DCA I @@100 ;Deposit AC to memory then clear AC, Indexed Current page @@100",			 // op 3700
	"DCA I @@101 ;Deposit AC to memory then clear AC, Indexed Current page @@101",			 // op 3701
	"DCA I @@102 ;Deposit AC to memory then clear AC, Indexed Current page @@102",			 // op 3702
	"DCA I @@103 ;Deposit AC to memory then clear AC, Indexed Current page @@103",			 // op 3703
	"DCA I @@104 ;Deposit AC to memory then clear AC, Indexed Current page @@104",			 // op 3704
	"DCA I @@105 ;Deposit AC to memory then clear AC, Indexed Current page @@105",			 // op 3705
	"DCA I @@106 ;Deposit AC to memory then clear AC, Indexed Current page @@106",			 // op 3706
	"DCA I @@107 ;Deposit AC to memory then clear AC, Indexed Current page @@107",			 // op 3707
	"DCA I @@110 ;Deposit AC to memory then clear AC, Indexed Current page @@110",			 // op 3710
	"DCA I @@111 ;Deposit AC to memory then clear AC, Indexed Current page @@111",			 // op 3711
	"DCA I @@112 ;Deposit AC to memory then clear AC, Indexed Current page @@112",			 // op 3712
	"DCA I @@113 ;Deposit AC to memory then clear AC, Indexed Current page @@113",			 // op 3713
	"DCA I @@114 ;Deposit AC to memory then clear AC, Indexed Current page @@114",			 // op 3714
	"DCA I @@115 ;Deposit AC to memory then clear AC, Indexed Current page @@115",			 // op 3715
	"DCA I @@116 ;Deposit AC to memory then clear AC, Indexed Current page @@116",			 // op 3716
	"DCA I @@117 ;Deposit AC to memory then clear AC, Indexed Current page @@117",			 // op 3717
	"DCA I @@120 ;Deposit AC to memory then clear AC, Indexed Current page @@120",			 // op 3720
	"DCA I @@121 ;Deposit AC to memory then clear AC, Indexed Current page @@121",			 // op 3721
	"DCA I @@122 ;Deposit AC to memory then clear AC, Indexed Current page @@122",			 // op 3722
	"DCA I @@123 ;Deposit AC to memory then clear AC, Indexed Current page @@123",			 // op 3723
	"DCA I @@124 ;Deposit AC to memory then clear AC, Indexed Current page @@124",			 // op 3724
	"DCA I @@125 ;Deposit AC to memory then clear AC, Indexed Current page @@125",			 // op 3725
	"DCA I @@126 ;Deposit AC to memory then clear AC, Indexed Current page @@126",			 // op 3726
	"DCA I @@127 ;Deposit AC to memory then clear AC, Indexed Current page @@127",			 // op 3727
	"DCA I @@130 ;Deposit AC to memory then clear AC, Indexed Current page @@130",			 // op 3730
	"DCA I @@131 ;Deposit AC to memory then clear AC, Indexed Current page @@131",			 // op 3731
	"DCA I @@132 ;Deposit AC to memory then clear AC, Indexed Current page @@132",			 // op 3732
	"DCA I @@133 ;Deposit AC to memory then clear AC, Indexed Current page @@133",			 // op 3733
	"DCA I @@134 ;Deposit AC to memory then clear AC, Indexed Current page @@134",			 // op 3734
	"DCA I @@135 ;Deposit AC to memory then clear AC, Indexed Current page @@135",			 // op 3735
	"DCA I @@136 ;Deposit AC to memory then clear AC, Indexed Current page @@136",			 // op 3736
	"DCA I @@137 ;Deposit AC to memory then clear AC, Indexed Current page @@137",			 // op 3737
	"DCA I @@140 ;Deposit AC to memory then clear AC, Indexed Current page @@140",			 // op 3740
	"DCA I @@141 ;Deposit AC to memory then clear AC, Indexed Current page @@141",			 // op 3741
	"DCA I @@142 ;Deposit AC to memory then clear AC, Indexed Current page @@142",			 // op 3742
	"DCA I @@143 ;Deposit AC to memory then clear AC, Indexed Current page @@143",			 // op 3743
	"DCA I @@144 ;Deposit AC to memory then clear AC, Indexed Current page @@144",			 // op 3744
	"DCA I @@145 ;Deposit AC to memory then clear AC, Indexed Current page @@145",			 // op 3745
	"DCA I @@146 ;Deposit AC to memory then clear AC, Indexed Current page @@146",			 // op 3746
	"DCA I @@147 ;Deposit AC to memory then clear AC, Indexed Current page @@147",			 // op 3747
	"DCA I @@150 ;Deposit AC to memory then clear AC, Indexed Current page @@150",			 // op 3750
	"DCA I @@151 ;Deposit AC to memory then clear AC, Indexed Current page @@151",			 // op 3751
	"DCA I @@152 ;Deposit AC to memory then clear AC, Indexed Current page @@152",			 // op 3752
	"DCA I @@153 ;Deposit AC to memory then clear AC, Indexed Current page @@153",			 // op 3753
	"DCA I @@154 ;Deposit AC to memory then clear AC, Indexed Current page @@154",			 // op 3754
	"DCA I @@155 ;Deposit AC to memory then clear AC, Indexed Current page @@155",			 // op 3755
	"DCA I @@156 ;Deposit AC to memory then clear AC, Indexed Current page @@156",			 // op 3756
	"DCA I @@157 ;Deposit AC to memory then clear AC, Indexed Current page @@157",			 // op 3757
	"DCA I @@160 ;Deposit AC to memory then clear AC, Indexed Current page @@160",			 // op 3760
	"DCA I @@161 ;Deposit AC to memory then clear AC, Indexed Current page @@161",			 // op 3761
	"DCA I @@162 ;Deposit AC to memory then clear AC, Indexed Current page @@162",			 // op 3762
	"DCA I @@163 ;Deposit AC to memory then clear AC, Indexed Current page @@163",			 // op 3763
	"DCA I @@164 ;Deposit AC to memory then clear AC, Indexed Current page @@164",			 // op 3764
	"DCA I @@165 ;Deposit AC to memory then clear AC, Indexed Current page @@165",			 // op 3765
	"DCA I @@166 ;Deposit AC to memory then clear AC, Indexed Current page @@166",			 // op 3766
	"DCA I @@167 ;Deposit AC to memory then clear AC, Indexed Current page @@167",			 // op 3767
	"DCA I @@170 ;Deposit AC to memory then clear AC, Indexed Current page @@170",			 // op 3770
	"DCA I @@171 ;Deposit AC to memory then clear AC, Indexed Current page @@171",			 // op 3771
	"DCA I @@172 ;Deposit AC to memory then clear AC, Indexed Current page @@172",			 // op 3772
	"DCA I @@173 ;Deposit AC to memory then clear AC, Indexed Current page @@173",			 // op 3773
	"DCA I @@174 ;Deposit AC to memory then clear AC, Indexed Current page @@174",			 // op 3774
	"DCA I @@175 ;Deposit AC to memory then clear AC, Indexed Current page @@175",			 // op 3775
	"DCA I @@176 ;Deposit AC to memory then clear AC, Indexed Current page @@176",			 // op 3776
	"DCA I @@177 ;Deposit AC to memory then clear AC, Indexed Current page @@177",			 // op 3777
	...
	"JMS @@100  ;Jump to subroutine Current page @@100",									 // op 4300
	"JMS @@101  ;Jump to subroutine Current page @@101",									 // op 4301
	"JMS @@102  ;Jump to subroutine Current page @@102",									 // op 4302
	"JMS @@103  ;Jump to subroutine Current page @@103",									 // op 4303
	"JMS @@104  ;Jump to subroutine Current page @@104",									 // op 4304
	"JMS @@105  ;Jump to subroutine Current page @@105",									 // op 4305
	"JMS @@106  ;Jump to subroutine Current page @@106",									 // op 4306
	"JMS @@107  ;Jump to subroutine Current page @@107",									 // op 4307
	"JMS @@110  ;Jump to subroutine Current page @@110",									 // op 4310
	"JMS @@111  ;Jump to subroutine Current page @@111",									 // op 4311
	"JMS @@112  ;Jump to subroutine Current page @@112",									 // op 4312
	"JMS @@113  ;Jump to subroutine Current page @@113",									 // op 4313
	"JMS @@114  ;Jump to subroutine Current page @@114",									 // op 4314
	"JMS @@115  ;Jump to subroutine Current page @@115",									 // op 4315
	"JMS @@116  ;Jump to subroutine Current page @@116",									 // op 4316
	"JMS @@117  ;Jump to subroutine Current page @@117",									 // op 4317
	"JMS @@120  ;Jump to subroutine Current page @@120",									 // op 4320
	"JMS @@121  ;Jump to subroutine Current page @@121",									 // op 4321
	"JMS @@122  ;Jump to subroutine Current page @@122",									 // op 4322
	"JMS @@123  ;Jump to subroutine Current page @@123",									 // op 4323
	"JMS @@124  ;Jump to subroutine Current page @@124",									 // op 4324
	"JMS @@125  ;Jump to subroutine Current page @@125",									 // op 4325
	"JMS @@126  ;Jump to subroutine Current page @@126",									 // op 4326
	"JMS @@127  ;Jump to subroutine Current page @@127",									 // op 4327
	"JMS @@130  ;Jump to subroutine Current page @@130",									 // op 4330
	"JMS @@131  ;Jump to subroutine Current page @@131",									 // op 4331
	"JMS @@132  ;Jump to subroutine Current page @@132",									 // op 4332
	"JMS @@133  ;Jump to subroutine Current page @@133",									 // op 4333
	"JMS @@134  ;Jump to subroutine Current page @@134",									 // op 4334
	"JMS @@135  ;Jump to subroutine Current page @@135",									 // op 4335
	"JMS @@136  ;Jump to subroutine Current page @@136",									 // op 4336
	"JMS @@137  ;Jump to subroutine Current page @@137",									 // op 4337
	"JMS @@140  ;Jump to subroutine Current page @@140",									 // op 4340
	"JMS @@141  ;Jump to subroutine Current page @@141",									 // op 4341
	"JMS @@142  ;Jump to subroutine Current page @@142",									 // op 4342
	"JMS @@143  ;Jump to subroutine Current page @@143",									 // op 4343
	"JMS @@144  ;Jump to subroutine Current page @@144",									 // op 4344
	"JMS @@145  ;Jump to subroutine Current page @@145",									 // op 4345
	"JMS @@146  ;Jump to subroutine Current page @@146",									 // op 4346
	"JMS @@147  ;Jump to subroutine Current page @@147",									 // op 4347
	"JMS @@150  ;Jump to subroutine Current page @@150",									 // op 4350
	"JMS @@151  ;Jump to subroutine Current page @@151",									 // op 4351
	"JMS @@152  ;Jump to subroutine Current page @@152",									 // op 4352
	"JMS @@153  ;Jump to subroutine Current page @@153",									 // op 4353
	"JMS @@154  ;Jump to subroutine Current page @@154",									 // op 4354
	"JMS @@155  ;Jump to subroutine Current page @@155",									 // op 4355
	"JMS @@156  ;Jump to subroutine Current page @@156",									 // op 4356
	"JMS @@157  ;Jump to subroutine Current page @@157",									 // op 4357
	"JMS @@160  ;Jump to subroutine Current page @@160",									 // op 4360
	"JMS @@161  ;Jump to subroutine Current page @@161",									 // op 4361
	"JMS @@162  ;Jump to subroutine Current page @@162",									 // op 4362
	"JMS @@163  ;Jump to subroutine Current page @@163",									 // op 4363
	"JMS @@164  ;Jump to subroutine Current page @@164",									 // op 4364
	"JMS @@165  ;Jump to subroutine Current page @@165",									 // op 4365
	"JMS @@166  ;Jump to subroutine Current page @@166",									 // op 4366
	"JMS @@167  ;Jump to subroutine Current page @@167",									 // op 4367
	"JMS @@170  ;Jump to subroutine Current page @@170",									 // op 4370
	"JMS @@171  ;Jump to subroutine Current page @@171",									 // op 4371
	"JMS @@172  ;Jump to subroutine Current page @@172",									 // op 4372
	"JMS @@173  ;Jump to subroutine Current page @@173",									 // op 4373
	"JMS @@174  ;Jump to subroutine Current page @@174",									 // op 4374
	"JMS @@175  ;Jump to subroutine Current page @@175",									 // op 4375
	"JMS @@176  ;Jump to subroutine Current page @@176",									 // op 4376
	"JMS @@177  ;Jump to subroutine Current page @@177",									 // op 4377
	...
	"JMS I @@100 ;Jump to subroutine Indexed Current page @@100",							 // op 4700
	"JMS I @@101 ;Jump to subroutine Indexed Current page @@101",							 // op 4701
	"JMS I @@102 ;Jump to subroutine Indexed Current page @@102",							 // op 4702
	"JMS I @@103 ;Jump to subroutine Indexed Current page @@103",							 // op 4703
	"JMS I @@104 ;Jump to subroutine Indexed Current page @@104",							 // op 4704
	"JMS I @@105 ;Jump to subroutine Indexed Current page @@105",							 // op 4705
	"JMS I @@106 ;Jump to subroutine Indexed Current page @@106",							 // op 4706
	"JMS I @@107 ;Jump to subroutine Indexed Current page @@107",							 // op 4707
	"JMS I @@110 ;Jump to subroutine Indexed Current page @@110",							 // op 4710
	"JMS I @@111 ;Jump to subroutine Indexed Current page @@111",							 // op 4711
	"JMS I @@112 ;Jump to subroutine Indexed Current page @@112",							 // op 4712
	"JMS I @@113 ;Jump to subroutine Indexed Current page @@113",							 // op 4713
	"JMS I @@114 ;Jump to subroutine Indexed Current page @@114",							 // op 4714
	"JMS I @@115 ;Jump to subroutine Indexed Current page @@115",							 // op 4715
	"JMS I @@116 ;Jump to subroutine Indexed Current page @@116",							 // op 4716
	"JMS I @@117 ;Jump to subroutine Indexed Current page @@117",							 // op 4717
	"JMS I @@120 ;Jump to subroutine Indexed Current page @@120",							 // op 4720
	"JMS I @@121 ;Jump to subroutine Indexed Current page @@121",							 // op 4721
	"JMS I @@122 ;Jump to subroutine Indexed Current page @@122",							 // op 4722
	"JMS I @@123 ;Jump to subroutine Indexed Current page @@123",							 // op 4723
	"JMS I @@124 ;Jump to subroutine Indexed Current page @@124",							 // op 4724
	"JMS I @@125 ;Jump to subroutine Indexed Current page @@125",							 // op 4725
	"JMS I @@126 ;Jump to subroutine Indexed Current page @@126",							 // op 4726
	"JMS I @@127 ;Jump to subroutine Indexed Current page @@127",							 // op 4727
	"JMS I @@130 ;Jump to subroutine Indexed Current page @@130",							 // op 4730
	"JMS I @@131 ;Jump to subroutine Indexed Current page @@131",							 // op 4731
	"JMS I @@132 ;Jump to subroutine Indexed Current page @@132",							 // op 4732
	"JMS I @@133 ;Jump to subroutine Indexed Current page @@133",							 // op 4733
	"JMS I @@134 ;Jump to subroutine Indexed Current page @@134",							 // op 4734
	"JMS I @@135 ;Jump to subroutine Indexed Current page @@135",							 // op 4735
	"JMS I @@136 ;Jump to subroutine Indexed Current page @@136",							 // op 4736
	"JMS I @@137 ;Jump to subroutine Indexed Current page @@137",							 // op 4737
	"JMS I @@140 ;Jump to subroutine Indexed Current page @@140",							 // op 4740
	"JMS I @@141 ;Jump to subroutine Indexed Current page @@141",							 // op 4741
	"JMS I @@142 ;Jump to subroutine Indexed Current page @@142",							 // op 4742
	"JMS I @@143 ;Jump to subroutine Indexed Current page @@143",							 // op 4743
	"JMS I @@144 ;Jump to subroutine Indexed Current page @@144",							 // op 4744
	"JMS I @@145 ;Jump to subroutine Indexed Current page @@145",							 // op 4745
	"JMS I @@146 ;Jump to subroutine Indexed Current page @@146",							 // op 4746
	"JMS I @@147 ;Jump to subroutine Indexed Current page @@147",							 // op 4747
	"JMS I @@150 ;Jump to subroutine Indexed Current page @@150",							 // op 4750
	"JMS I @@151 ;Jump to subroutine Indexed Current page @@151",							 // op 4751
	"JMS I @@152 ;Jump to subroutine Indexed Current page @@152",							 // op 4752
	"JMS I @@153 ;Jump to subroutine Indexed Current page @@153",							 // op 4753
	"JMS I @@154 ;Jump to subroutine Indexed Current page @@154",							 // op 4754
	"JMS I @@155 ;Jump to subroutine Indexed Current page @@155",							 // op 4755
	"JMS I @@156 ;Jump to subroutine Indexed Current page @@156",							 // op 4756
	"JMS I @@157 ;Jump to subroutine Indexed Current page @@157",							 // op 4757
	"JMS I @@160 ;Jump to subroutine Indexed Current page @@160",							 // op 4760
	"JMS I @@161 ;Jump to subroutine Indexed Current page @@161",							 // op 4761
	"JMS I @@162 ;Jump to subroutine Indexed Current page @@162",							 // op 4762
	"JMS I @@163 ;Jump to subroutine Indexed Current page @@163",							 // op 4763
	"JMS I @@164 ;Jump to subroutine Indexed Current page @@164",							 // op 4764
	"JMS I @@165 ;Jump to subroutine Indexed Current page @@165",							 // op 4765
	"JMS I @@166 ;Jump to subroutine Indexed Current page @@166",							 // op 4766
	"JMS I @@167 ;Jump to subroutine Indexed Current page @@167",							 // op 4767
	"JMS I @@170 ;Jump to subroutine Indexed Current page @@170",							 // op 4770
	"JMS I @@171 ;Jump to subroutine Indexed Current page @@171",							 // op 4771
	"JMS I @@172 ;Jump to subroutine Indexed Current page @@172",							 // op 4772
	"JMS I @@173 ;Jump to subroutine Indexed Current page @@173",							 // op 4773
	"JMS I @@174 ;Jump to subroutine Indexed Current page @@174",							 // op 4774
	"JMS I @@175 ;Jump to subroutine Indexed Current page @@175",							 // op 4775
	"JMS I @@176 ;Jump to subroutine Indexed Current page @@176",							 // op 4776
	"JMS I @@177 ;Jump to subroutine Indexed Current page @@177",							 // op 4777
	...
	"JMP @@100  ;Jump Current page @@100",													 // op 5300
	"JMP @@101  ;Jump Current page @@101",													 // op 5301
	"JMP @@102  ;Jump Current page @@102",													 // op 5302
	"JMP @@103  ;Jump Current page @@103",													 // op 5303
	"JMP @@104  ;Jump Current page @@104",													 // op 5304
	"JMP @@105  ;Jump Current page @@105",													 // op 5305
	"JMP @@106  ;Jump Current page @@106",													 // op 5306
	"JMP @@107  ;Jump Current page @@107",													 // op 5307
	"JMP @@110  ;Jump Current page @@110",													 // op 5310
	"JMP @@111  ;Jump Current page @@111",													 // op 5311
	"JMP @@112  ;Jump Current page @@112",													 // op 5312
	"JMP @@113  ;Jump Current page @@113",													 // op 5313
	"JMP @@114  ;Jump Current page @@114",													 // op 5314
	"JMP @@115  ;Jump Current page @@115",													 // op 5315
	"JMP @@116  ;Jump Current page @@116",													 // op 5316
	"JMP @@117  ;Jump Current page @@117",													 // op 5317
	"JMP @@120  ;Jump Current page @@120",													 // op 5320
	"JMP @@121  ;Jump Current page @@121",													 // op 5321
	"JMP @@122  ;Jump Current page @@122",													 // op 5322
	"JMP @@123  ;Jump Current page @@123",													 // op 5323
	"JMP @@124  ;Jump Current page @@124",													 // op 5324
	"JMP @@125  ;Jump Current page @@125",													 // op 5325
	"JMP @@126  ;Jump Current page @@126",													 // op 5326
	"JMP @@127  ;Jump Current page @@127",													 // op 5327
	"JMP @@130  ;Jump Current page @@130",													 // op 5330
	"JMP @@131  ;Jump Current page @@131",													 // op 5331
	"JMP @@132  ;Jump Current page @@132",													 // op 5332
	"JMP @@133  ;Jump Current page @@133",													 // op 5333
	"JMP @@134  ;Jump Current page @@134",													 // op 5334
	"JMP @@135  ;Jump Current page @@135",													 // op 5335
	"JMP @@136  ;Jump Current page @@136",													 // op 5336
	"JMP @@137  ;Jump Current page @@137",													 // op 5337
	"JMP @@140  ;Jump Current page @@140",													 // op 5340
	"JMP @@141  ;Jump Current page @@141",													 // op 5341
	"JMP @@142  ;Jump Current page @@142",													 // op 5342
	"JMP @@143  ;Jump Current page @@143",													 // op 5343
	"JMP @@144  ;Jump Current page @@144",													 // op 5344
	"JMP @@145  ;Jump Current page @@145",													 // op 5345
	"JMP @@146  ;Jump Current page @@146",													 // op 5346
	"JMP @@147  ;Jump Current page @@147",													 // op 5347
	"JMP @@150  ;Jump Current page @@150",													 // op 5350
	"JMP @@151  ;Jump Current page @@151",													 // op 5351
	"JMP @@152  ;Jump Current page @@152",													 // op 5352
	"JMP @@153  ;Jump Current page @@153",													 // op 5353
	"JMP @@154  ;Jump Current page @@154",													 // op 5354
	"JMP @@155  ;Jump Current page @@155",													 // op 5355
	"JMP @@156  ;Jump Current page @@156",													 // op 5356
	"JMP @@157  ;Jump Current page @@157",													 // op 5357
	"JMP @@160  ;Jump Current page @@160",													 // op 5360
	"JMP @@161  ;Jump Current page @@161",													 // op 5361
	"JMP @@162  ;Jump Current page @@162",													 // op 5362
	"JMP @@163  ;Jump Current page @@163",													 // op 5363
	"JMP @@164  ;Jump Current page @@164",													 // op 5364
	"JMP @@165  ;Jump Current page @@165",													 // op 5365
	"JMP @@166  ;Jump Current page @@166",													 // op 5366
	"JMP @@167  ;Jump Current page @@167",													 // op 5367
	"JMP @@170  ;Jump Current page @@170",													 // op 5370
	"JMP @@171  ;Jump Current page @@171",													 // op 5371
	"JMP @@172  ;Jump Current page @@172",													 // op 5372
	"JMP @@173  ;Jump Current page @@173",													 // op 5373
	"JMP @@174  ;Jump Current page @@174",													 // op 5374
	"JMP @@175  ;Jump Current page @@175",													 // op 5375
	"JMP @@176  ;Jump Current page @@176",													 // op 5376
	"JMP @@177  ;Jump Current page @@177",													 // op 5377
	...
	"JMP I @@100 ;Jump Indexed Current page @@100",											 // op 5700
	"JMP I @@101 ;Jump Indexed Current page @@101",											 // op 5701
	"JMP I @@102 ;Jump Indexed Current page @@102",											 // op 5702
	"JMP I @@103 ;Jump Indexed Current page @@103",											 // op 5703
	"JMP I @@104 ;Jump Indexed Current page @@104",											 // op 5704
	"JMP I @@105 ;Jump Indexed Current page @@105",											 // op 5705
	"JMP I @@106 ;Jump Indexed Current page @@106",											 // op 5706
	"JMP I @@107 ;Jump Indexed Current page @@107",											 // op 5707
	"JMP I @@110 ;Jump Indexed Current page @@110",											 // op 5710
	"JMP I @@111 ;Jump Indexed Current page @@111",											 // op 5711
	"JMP I @@112 ;Jump Indexed Current page @@112",											 // op 5712
	"JMP I @@113 ;Jump Indexed Current page @@113",											 // op 5713
	"JMP I @@114 ;Jump Indexed Current page @@114",											 // op 5714
	"JMP I @@115 ;Jump Indexed Current page @@115",											 // op 5715
	"JMP I @@116 ;Jump Indexed Current page @@116",											 // op 5716
	"JMP I @@117 ;Jump Indexed Current page @@117",											 // op 5717
	"JMP I @@120 ;Jump Indexed Current page @@120",											 // op 5720
	"JMP I @@121 ;Jump Indexed Current page @@121",											 // op 5721
	"JMP I @@122 ;Jump Indexed Current page @@122",											 // op 5722
	"JMP I @@123 ;Jump Indexed Current page @@123",											 // op 5723
	"JMP I @@124 ;Jump Indexed Current page @@124",											 // op 5724
	"JMP I @@125 ;Jump Indexed Current page @@125",											 // op 5725
	"JMP I @@126 ;Jump Indexed Current page @@126",											 // op 5726
	"JMP I @@127 ;Jump Indexed Current page @@127",											 // op 5727
	"JMP I @@130 ;Jump Indexed Current page @@130",											 // op 5730
	"JMP I @@131 ;Jump Indexed Current page @@131",											 // op 5731
	"JMP I @@132 ;Jump Indexed Current page @@132",											 // op 5732
	"JMP I @@133 ;Jump Indexed Current page @@133",											 // op 5733
	"JMP I @@134 ;Jump Indexed Current page @@134",											 // op 5734
	"JMP I @@135 ;Jump Indexed Current page @@135",											 // op 5735
	"JMP I @@136 ;Jump Indexed Current page @@136",											 // op 5736
	"JMP I @@137 ;Jump Indexed Current page @@137",											 // op 5737
	"JMP I @@140 ;Jump Indexed Current page @@140",											 // op 5740
	"JMP I @@141 ;Jump Indexed Current page @@141",											 // op 5741
	"JMP I @@142 ;Jump Indexed Current page @@142",											 // op 5742
	"JMP I @@143 ;Jump Indexed Current page @@143",											 // op 5743
	"JMP I @@144 ;Jump Indexed Current page @@144",											 // op 5744
	"JMP I @@145 ;Jump Indexed Current page @@145",											 // op 5745
	"JMP I @@146 ;Jump Indexed Current page @@146",											 // op 5746
	"JMP I @@147 ;Jump Indexed Current page @@147",											 // op 5747
	"JMP I @@150 ;Jump Indexed Current page @@150",											 // op 5750
	"JMP I @@151 ;Jump Indexed Current page @@151",											 // op 5751
	"JMP I @@152 ;Jump Indexed Current page @@152",											 // op 5752
	"JMP I @@153 ;Jump Indexed Current page @@153",											 // op 5753
	"JMP I @@154 ;Jump Indexed Current page @@154",											 // op 5754
	"JMP I @@155 ;Jump Indexed Current page @@155",											 // op 5755
	"JMP I @@156 ;Jump Indexed Current page @@156",											 // op 5756
	"JMP I @@157 ;Jump Indexed Current page @@157",											 // op 5757
	"JMP I @@160 ;Jump Indexed Current page @@160",											 // op 5760
	"JMP I @@161 ;Jump Indexed Current page @@161",											 // op 5761
	"JMP I @@162 ;Jump Indexed Current page @@162",											 // op 5762
	"JMP I @@163 ;Jump Indexed Current page @@163",											 // op 5763
	"JMP I @@164 ;Jump Indexed Current page @@164",											 // op 5764
	"JMP I @@165 ;Jump Indexed Current page @@165",											 // op 5765
	"JMP I @@166 ;Jump Indexed Current page @@166",											 // op 5766
	"JMP I @@167 ;Jump Indexed Current page @@167",											 // op 5767
	"JMP I @@170 ;Jump Indexed Current page @@170",											 // op 5770
	"JMP I @@171 ;Jump Indexed Current page @@171",											 // op 5771
	"JMP I @@172 ;Jump Indexed Current page @@172",											 // op 5772
	"JMP I @@173 ;Jump Indexed Current page @@173",											 // op 5773
	"JMP I @@174 ;Jump Indexed Current page @@174",											 // op 5774
	"JMP I @@175 ;Jump Indexed Current page @@175",											 // op 5775
	"JMP I @@176 ;Jump Indexed Current page @@176",											 // op 5776
	"JMP I @@177 ;Jump Indexed Current page @@177",											 // op 5777
